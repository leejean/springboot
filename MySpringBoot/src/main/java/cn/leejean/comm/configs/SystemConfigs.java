package cn.leejean.comm.configs;
...
public class SystemConfigs {
	 ...
	 * 是否显示请求参数
	 */
    @Value("${cn.leejean.comm.configs.show_request_params}")
    public Boolean show_request_params = false;
    /**
     * 是否显示响应结果
     */
    @Value("${cn.leejean.comm.configs.show_response_datas}")
    public Boolean show_response_datas = false;
    /**
     * 日志切面配置
     */
    @Value("${cn.leejean.comm.aspect.pointcut}")
    public String aspect_pointcut = "";
    
    @Value("${cn.leejean.comm.configs.logger2mongo}")
